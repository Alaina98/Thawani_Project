					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        <!--begin::Page title-->
								<div class="page-title d-flex flex-column me-5 py-2">
									<!--begin::Title-->
									<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">User's list</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
										...
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">
                                            <a  href="http://127.0.0.1:8000/user-list" class="text-muted text-hover-primary">Users list</a>
                                            </li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
													...
													<div class="px-7 py-5" data-kt-user-table-filter="form">
														...
														<div class="mb-10">
															...
															<select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
																...
																<option value="Support">QA_QC</option>
															...
															<form id="kt_modal_export_users_form" class="form" action="#">
																...
																<div class="fv-row mb-10">
																	...
																	<select name="role" data-control="select2" data-placeholder="Select a role" data-hide-search="true" class="form-select form-select-solid fw-bold">
																		<option></option>
																		<option value="Administrator">Administrator</option>
																		<option value="Analyst">QA_QC</option>
																		<option value="Developer">Developer</option>
															...
															<form id="kt_modal_add_user_form" class="form" action="#">
																...
																<div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																	...
																	<div class="fv-row mb-7">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="text" name="user_name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Full name" value="Alaina Dawood" />
																		<!--end::Input-->
																	</div>
																	<!--end::Input group-->
																	<!--begin::Input group-->
																	<div class="fv-row mb-7">
																		...
																		<!--end::Label-->
																		<!--begin::Input-->
																		<input type="email" name="user_email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="example@domain.com" value="alaina@gmail.com" />
																		<!--end::Input-->
																	</div>
																	<!--end::Input group-->
																	<!--begin::Input group-->
																		...
																		<div class="d-flex fv-row">
																			...
																			<div class="form-check form-check-custom form-check-solid">
																				...
																				<label class="form-check-label" for="kt_modal_update_role_option_3">
																					<div class="fw-bold text-gray-800">QA_QC</div>
																					<div class="text-gray-600">Best for employees who  develop and implement quality assurance plans, test products and services to ensure they meet the required standards</div>
																				</label>
																				<!--end::Label-->
																			</div>
																			<!--end::Radio-->
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
															<a href="../../demo10/dist/apps/user-management/users/view.html">
																<div class="symbol-label">
																	<img src="templates/t1/assets/media/avatars/a.png" alt="Emma Smith" class="w-100" />
																</div>
															</a>
														</div>
														<!--end::Avatar-->
														...
														<div class="d-flex flex-column">
															...
															<span>alaina.aladwi@gmail.com</span>
														</div>
														<!--begin::User details-->
													</td>
													<td>Administrator</td>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
															<a href="../../demo10/dist/apps/user-management/users/view.html">
																<div class="symbol-label">
																	<img src="templates/t1/assets/media/avatars/sun.jfif" alt="Brian Cox" class="w-100" />
																</div>
															</a>
														</div>
														<!--end::Avatar-->
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
															<a href="../../demo10/dist/apps/user-management/users/view.html">
																<div class="symbol-label">
																	<img src="templates/t1/assets/media/avatars/blank.png" alt="Brian Cox" class="w-100" />
																</div>
															</a>
														</div>
														<!--end::Avatar-->
														<!--begin::User details-->
														<div class="d-flex flex-column">
															<a href="../../demo10/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Khalfan Amri</a>
															<span>Khalfan@gmail.com</span>
														</div>
														<!--begin::User details-->
													</td>
													<td>Administrator</td>
