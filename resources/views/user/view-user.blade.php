					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        <!--begin::Page title-->
								<div class="page-title d-flex flex-column me-5 py-2">
									<!--begin::Title-->
									<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">View User Details</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
											...
											<div class="card-body">
												...
												<div class="d-flex flex-center flex-column py-5">
													...
													<div class="symbol symbol-100px symbol-circle mb-7">
														<img src="/templates/t1/assets/media/avatars/a.png" alt="image" />
													</div>
													<!--end::Avatar-->
													<!--begin::Name-->
													<a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">Alaina Dawood</a>
													<!--end::Name-->
													<!--begin::Position-->
													<div class="mb-9">
														<!--begin::Badge-->
														<div class="badge badge-lg badge-light-primary d-inline">Developer</div>
														<!--begin::Badge-->
													</div>
													<!--end::Position-->
													<!--begin::Info-->
													<!--begin::Info heading-->
													<div class="fw-bold mb-3">Assigned Test Cases
												...
												<div id="kt_user_view_details" class="collapse show">
													<div class="pb-5 fs-6">
														...
														<div class="text-gray-600">
															<a href="#" class="text-gray-600 text-hover-primary">alaina.aladwi@gmail.com</a>
														</div>
														<!--begin::Details item-->
														<!--begin::Details item-->
														<div class="fw-bold mt-5">Address</div>
														<div class="text-gray-600">Muscat
														<br />Bushar
														<br />Oman</div>
														<!--begin::Details item-->
														<!--begin::Details item-->
												...
												<div class="card card-flush mb-6 mb-xl-9">
													...
													<div class="card-header mt-6">
														...
														<div class="card-title flex-column">
															<h2 class="mb-1">User's Test Cases</h2>
													...
													<div class="card-body d-flex flex-column">
														...
														<div class="d-flex align-items-center position-relative mb-7">
															...
															<div class="fw-semibold ms-5">
																<a href="#" class="fs-5 fw-bold text-dark text-hover-primary">Change the search Bar</a>
																<!--begin::Info-->
																<div class="fs-7 text-muted">Not Work in Finance Department
																</div>
																<!--end::Info-->
															</div>
															<!--end::Details-->
														...
														<div class="d-flex align-items-center position-relative mb-7">
															...
															<!--begin::Details-->
															<div class="fw-semibold ms-5">
																<a href="#" class="fs-5 fw-bold text-dark text-hover-primary">Networking Problem</a>
																<!--begin::Info-->
