						...
						<div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack flex-wrap">
								...
								<div class="page-title d-flex flex-column me-5 py-2">
									<!--begin::Title-->
									<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">View TestCase</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">View Test</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
								...
								<div class="card mb-5 mb-xl-8">
									...
									<div class="card-header border-0 pt-5">
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label fw-bold fs-3 mb-1">TestCase: </span>
											<span class="text-muted mt-1 fw-semibold fs-7">Over 30 TestCase</span>
										</h3>
											...
											<table class="table align-middle gs-0 gy-4">
												...
												<thead>
													<tr class="fw-bold text-muted bg-light">
														<th class="ps-4 min-w-300px rounded-start">TestCase</th>
												...
												<tbody>
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Search</a>
																	<span class="text-muted fw-semibold text-muted d-block fs-7">12</span>
																</div>
															</div>
														</td>
														...
														<td>
															<a href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">Change language</a>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Moojeb</a>
														...
														<td>
															<a href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">Nefication</a>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Tajer </a>
																	<span class="text-muted fw-semibold text-muted d-block fs-7">10</span>
																</div>
															</div>
														</td>
														<td>
															<a href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">Search</a>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Log In</a>
																	<span class="text-muted fw-semibold text-muted d-block fs-7">5</span>
																</div>
															</div>
														</td>
														<td>
															<a href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">Incorrect Email</a>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Password</a>
																	<span class="text-muted fw-semibold text-muted d-block fs-7">8 </span>
																</div>
															</div>
														</td>
														<td>
															<a href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">8 chart</a>
