						...
						<div class="container-fluid">
							...
							<div class="header-brand me-5">
								...
								<a href="../../demo10/dist/index.html">
                                    <img alt="Logo" src="/templates/t1/assets/media/logos/thawani.png" class="h-25px h-lg-30px d-none d-md-block" />
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<!--begin::Username-->
												<div class="d-flex flex-column">
													<div class="fw-bold d-flex align-items-center fs-5">Arwa
													<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span></div>
													<a href="#" class="fw-semibold text-muted text-hover-primary fs-7">Arwa@thawani.com</a>
												</div>
												<!--end::Username-->
											</div>
										</div>
						...
						<div class="toolbar d-flex flex-stack mb-3 mb-lg-5" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack flex-wrap">
								...
								<div class="page-title d-flex flex-column me-5 py-2">
									<!--begin::Title-->
									<h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">View User</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">View TestCase</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-200 w-5px h-2px"></span>
								...
								<div class="d-flex align-items-center py-2">
									...
									<div class="me-4">
										...
										<!--begin::Menu 1-->
										<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_64b7768d26a98">
											<!--begin::Header-->
											<div class="px-7 py-5">
											...
											<div class="px-7 py-5">
												...
												<div class="mb-10">
													...
													<!--begin::Input-->
													<div>
														<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_64b7768d26a98" data-allow-clear="true">
															<option></option>
								...
								<div class="card mb-5 mb-xl-8">
									...
									<div class="card-header border-0 pt-5">
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label fw-bold fs-3 mb-1">View User</span>
											<span class="text-muted mt-1 fw-semibold fs-7">Over 12 User</span>
										</h3>
														...
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Shrooq said</a>
																	<a href="#" class="text-muted text-hover-primary fw-semibold text-muted d-block fs-7">
																	<span class="text-dark">Email</span>: shrooq@thawani.com</a>
																</div>
																<!--end::Name-->
															</div>
														</td>

														<td class="text-muted fw-semibold text-end">1245</td>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<!--begin::Name-->
																<div class="d-flex justify-content-start flex-column">
																	<a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Mohammed</a>
																	<a href="#" class="text-muted text-hover-primary fw-semibold text-muted d-block fs-7">
																	<span class="text-dark">Email</span>: Mohammed@thawani.com</a>
																</div>
																<!--end::Name-->
															</div>
														</td>

														<td class="text-muted fw-semibold text-end">1554</td>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<!--begin::Name-->
																<div class="d-flex justify-content-start flex-column">
																	<a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Arwa</a>
																	<a href="#" class="text-muted text-hover-primary fw-semibold text-muted d-block fs-7">
																	<span class="text-dark">Email</span>: Arwa@thawani.com</a>
																</div>
																<!--end::Name-->
															</div>
														</td>

														<td class="text-muted fw-semibold text-end">1721</td>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<!--begin::Name-->
																<div class="d-flex justify-content-start flex-column">
																	<a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Yosif Mohammed</a>
																	<a href="#" class="text-muted text-hover-primary fw-semibold text-muted d-block fs-7">
																	<span class="text-dark">Email</span>:Yosif@thawani.com</a>
																</div>
																<!--end::Name-->
															</div>
														</td>

														<td class="text-muted fw-semibold text-end">1453</td>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<!--begin::Name-->
																<div class="d-flex justify-content-start flex-column">
																	<a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Khalfan AL-Amri</a>
																	<a href="#" class="text-muted text-hover-primary fw-semibold text-muted d-block fs-7">
																	<span class="text-dark">Email</span>:Khalfan@thawani.com</a>
																</div>
																<!--end::Name-->
															</div>
														</td>

														<td class="text-muted fw-semibold text-end">1522</td>
				...
				<div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
					...
					<div class="card-title">
						...
						<div class="d-flex justify-content-center flex-column me-3">
							<a href="#" class="fs-4 fw-bold text-gray-900 text-hover-primary me-1 mb-2 lh-1">Khalfan AL-Amri</a>
							<!--begin::Info-->
							<div class="mb-0 lh-1">
						...
						<div class="d-flex justify-content-start mb-10">
							...
							<div class="d-flex flex-column align-items-start">
								...
								<div class="d-flex align-items-center mb-2">
									...
									<!--begin::Details-->
									<div class="ms-3">
										<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary me-1">Khalfan AL-Amri</a>
							...
							<div class="mh-300px scroll-y me-n7 pe-7">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<!--begin::Details-->
										<div class="ms-5">
											<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Shrooq said</a>
											<div class="fw-semibold text-muted">shrooq@thawani.com</div>
										</div>
										<!--end::Details-->
									</div>
									<!--end::Details-->
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<!--begin::Details-->
										<div class="ms-5">
											<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Mohammed</a>
											<div class="fw-semibold text-muted">Mohammed@thawani.com</div>
										</div>
										<!--end::Details-->
									</div>
									<!--end::Details-->
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<!--begin::Details-->
										<div class="ms-5">
											<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Arwa</a>
											<div class="fw-semibold text-muted">Arwa@thawani.com</div>
										</div>
										<!--end::Details-->
									</div>
									<!--end::Details-->
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<!--begin::Details-->
										<div class="ms-5">
											<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Yosif Mohammed</a>
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<!--begin::Details-->
										<div class="ms-5">
											<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Khalfan AL-Amri</a>
									...
									<div class="mh-375px scroll-y me-n7 pe-7">
										...
										<a href="#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
											...
											<div class="fw-semibold">
												<span class="fs-6 text-gray-800 me-2">Shrooq said</span>
										...
										<a href="#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
											...
											<!--begin::Info-->
											<div class="fw-semibold">
												<span class="fs-6 text-gray-800 me-2">Mohammed</span>
										...
										<a href="#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
											...
											<!--begin::Info-->
											<div class="fw-semibold">
												<span class="fs-6 text-gray-800 me-2">Arwa</span>
										...
										<a href="#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
											...
											<!--begin::Info-->
											<div class="fw-semibold">
												<span class="fs-6 text-gray-800 me-2">Yosif Mohammed</span>
										...
										<a href="#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
											...
											<!--begin::Info-->
											<div class="fw-semibold">
												<span class="fs-6 text-gray-800 me-2">Khalfan AL-Amri</span>
